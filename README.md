...
- 설계서: [`docs/25년_SW개발_HW제작설계서_일반(개인정보 기재x).pptx`](docs/25년*SW개발\_HW제작설계서*일반(개인정보 기재x).pptx)
- 수행계획서: [`docs/2025년 ICT 한이음 드림업 프로젝트 수행계획서_StoryCraft.pdf`](docs/2025년 ICT 한이음 드림업 프로젝트 수행계획서\_StoryCraft.pdf)
- 결과보고서: [`docs/2025년 한이음 드림업 프로젝트 결과보고서_StoryCraft.pdf`](docs/2025년 한이음 드림업 프로젝트 결과보고서\_StoryCraft.pdf)
...
빌드 가이드는 [`docs/dev/dev.md`](docs/dev/dev.md#빌드) 를 참고하세요.
